...
params_calibrated = [macro1.g*400, macro1.gamma, macro1.rf*400, macro1.theta0^4, macro1.theta1, 0, macro1.gamma_x*4, macro1.gamma_pi, macro1.rho_i, ...
                    sqrt(macro1.sigma_vec(3))*400, asset.initialShockVec(3)*100, 0, macro1.rho_pi, macro1.kappa*4, 0, macro1.phi, macro1.delta]';

Table1 = table(round(params_calibrated,2));
Table1.Properties.VariableNames = {'Model Parameters'};
...
%% Table 2: Implied Model Parameters
params_implied = [macro1.betaq^4, macro1.Sbar, exp(macro1.smax), macro1.rhoxm, macro1.rhoxp, macro1.psi/4, macro1.theta2]';
Table2 = table(round(params_implied,2));
Table2.Properties.VariableNames = {'Implied Model Parameters'};
