...
classdef asset_p
    ...
    properties
        ...
        timeseries                 %   XXXFL: Structure of time series of asset returns.
        ...
        function asset  = SimulateMoments(asset_pI, num_set, macro_dyn)
            ...
            while j<=1    
                ...
                for t=3:T
                    ...
                    xminusinterp   = max(xminuslower, min(const3*ztildesim(:,t-1),xminusupper)); % this is the trucated last period real rate
...
%% Regress FOMC asset returns onto nominal rate changes on FOMC dates
        ...
        function asset = computeFn21(asset_pI, num_set, macro_dyn)
            ...
            while j<=Nsim
                ...
                xIrf       = Y(1,1:20) - Y(1,1);
                cIrf = (csim(1:20) - csim_ss(1:20)) - (csim(1) - csim_ss(1)); %XXXFL
